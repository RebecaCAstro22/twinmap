// LibrerÃƒÂ­a compartida: trae "Popular Times" (intensidad de gente) desde SerpAPI.
// Primero resuelve un lugar y luego consulta su detalle, donde SerpAPI entrega popular_times.

export const PLACES = [
  { q: "Centro HistÃ³rico San Salvador El Salvador", lat: 13.6989, lng: -89.1914, department: "San Salvador" },
  { q: "Parque Libertad Santa Ana El Salvador", lat: 13.9942, lng: -89.5597, department: "Santa Ana" },
  { q: "Parque La Concordia AhuachapÃ¡n El Salvador", lat: 13.9220, lng: -89.8450, department: "AhuachapÃ¡n" },
  { q: "Parque Rafael Campos Sonsonate El Salvador", lat: 13.7189, lng: -89.7240, department: "Sonsonate" },
  { q: "Parque Daniel HernÃ¡ndez Santa Tecla El Salvador", lat: 13.6766, lng: -89.2797, department: "La Libertad" },
  { q: "Parque Central Chalatenango El Salvador", lat: 14.0725, lng: -89.0941, department: "Chalatenango" },
  { q: "Parque Rafael Cabrera Cojutepeque El Salvador", lat: 13.7212, lng: -88.9364, department: "CuscatlÃ¡n" },
  { q: "Parque Central Zacatecoluca El Salvador", lat: 13.5007, lng: -88.8685, department: "La Paz" },
  { q: "Parque Central Sensuntepeque El Salvador", lat: 13.8668, lng: -88.6287, department: "CabaÃ±as" },
  { q: "Parque Central San Vicente El Salvador", lat: 13.6409, lng: -88.7850, department: "San Vicente" },
  { q: "Parque Central UsulutÃ¡n El Salvador", lat: 13.3458, lng: -88.4420, department: "UsulutÃ¡n" },
  { q: "Parque GuzmÃ¡n San Miguel El Salvador", lat: 13.4838, lng: -88.1772, department: "San Miguel" },
  { q: "Parque Central San Francisco Gotera El Salvador", lat: 13.6962, lng: -88.1011, department: "MorazÃ¡n" },
  { q: "Parque Central La UniÃ³n El Salvador", lat: 13.3362, lng: -87.8405, department: "La UniÃ³n" },
];
...
export async function fetchCrowds(key, places = PLACES) {
  ...
  for (const place of places) {
    try {
      ...
      console.warn(`crowds: fallÃƒÂ³ ${place.q}: ${error.message}`);
    }
  }
  return {
    type: "FeatureCollection",
    metadata: { source: "Google Popular Times vÃƒÂ­a SerpAPI", fetched_at: new Date().toISOString(), errors },
    features,
  };
}