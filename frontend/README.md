...
Esta entrega se enfoca en estructura y flujo de navegación. No incluye todavía diseño visual final, conexión con APIs reales ni persistencia de datos.
...
No existen endpoints, APIs externas ni integraciones reales en esta versión.

La aplicación funciona completamente en frontend estático:
